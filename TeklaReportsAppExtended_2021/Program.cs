...
namespace TeklaReportsApp
{
  class Program
  {
    ...
    static void Main()
    {
      ...
      string mutex_id = "TeklaReportsAppExtended_T2021";
      using (Mutex mutex = new Mutex(false, mutex_id))
        ...
        {
          Console.Title = "Grating Reports Extended for Tekla 2021";
          ...
          try
          {
            ...
            {
              ColorConsole.WriteLine("Oops... Tekla 2021 model is not conneted. Open a model and restart the app.", ConsoleColor.Red);
              Console.ReadLine();
            }
            ConsoleSettings.SetConsoleWindow();
