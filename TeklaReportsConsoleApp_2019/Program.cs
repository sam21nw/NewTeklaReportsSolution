...
namespace TeklaReportsApp
{
  class Program
  {
    ...
    static void Main()
    {
      ...
      string mutex_id = "TeklaReportsAppExtended_T2019";
      using (Mutex mutex = new Mutex(false, mutex_id))
        ...
        {
          Console.Title = "Grating Reports Extended for Tekla 2019";
          ...
          try
          {
            ...
            {
              ColorConsole.WriteLine("Oops... Tekla 2019 model is not conneted. Open a model and restart the app.", ConsoleColor.Red);
              Console.ReadLine();
            }
